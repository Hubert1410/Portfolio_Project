...
----- Loking at avarage score per country -----
...
----- Loking at avarage score per country with more than 20 movies in the database ----- SELECT W SELEKCIE, FUNKCJE?
...
----- Looking at movies Genres distribution -----
...
----- Is budget related to score? Total budget vs Score -----




----- Best 3 Movie from each Year + (Using a CTE) -----
...
----- Best 3 Movie from each Year + (Using a TEMP TABLE) -----
